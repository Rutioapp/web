...
export function HeroSection() {
  return (
    <section aria-labelledby="hero-heading" className="relative overflow-hidden pb-12 pt-6 sm:pb-16 sm:pt-8 lg:pb-20">
      ...
      <Container className="relative">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(22rem,30rem)] lg:items-center lg:gap-14 xl:gap-20">
          <HeroCopy />
          <HeroDevicePreview />
        </div>
      </Container>
