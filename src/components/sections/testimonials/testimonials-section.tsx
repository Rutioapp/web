...
export function TestimonialsSection() {
  ...
  return (
    <section aria-labelledby="testimonios-heading" className="border-t border-brand/12 bg-[#faf5ee] py-20 sm:py-24 lg:py-28">
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 id="testimonios-heading" className="text-balance text-[2.4rem] font-light leading-[1.02] sm:text-[3.15rem] lg:text-[3.35rem]">
