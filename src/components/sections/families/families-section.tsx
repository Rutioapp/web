    ...
    <section id="familias" aria-labelledby="familias-heading" className="relative overflow-hidden bg-foreground py-20 sm:py-24 lg:py-28">
      ...
      <Container className="relative z-10">
        ...
        <div className="mt-12 space-y-4 sm:space-y-5 lg:space-y-6">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch lg:grid-cols-4 lg:gap-5">
            {firstRow.map((family) => (
              <FamilyCard key={family.slug} family={family} />
            ))}
          </div>

          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch lg:mx-auto lg:max-w-[75%] lg:grid-cols-3 lg:gap-5">
